...
function handleChecked() {
    ...
    if (checked.value) {
        itemRef.value.classList.add("item--selected")
    } else {
        itemRef.value.classList.remove("item--selected")
    }
}
</script>
...
<div class="item" ref="itemRef">
    <div class="item__top">
        <div class="top-wrapper">
            <NFlex class="content" :size="0" justify="space-between" align="center">
                <div class="select">
                    <NCheckbox :checked="checked" :value="props.id" size="medium" @click="handleChecked"/>
                </div>
    ...
    <NFlex class="item__body" @click="props.isFolder? emits('select', props.id): null" :size="0" :vertical="true"
